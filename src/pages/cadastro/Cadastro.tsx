...
function Cadastro() {
    ...
    const [isLoading, setIsLoading] = useState<boolean>(false) //hook de estado//
    ...
    useEffect(() => { // useEffect é acionado quando o estado incial muda//
        if (usuario.id !== 0) {
            retornar()
        }
    }, [usuario])
            ...
            place-items-center font-bold bg-gray-200">
                ...
                <form className='flex justify-center items-center flex-col w-2/3 gap-3' onSubmit={cadastrarNovoUsuario}>
                    ...
                    <div className="flex justify-around w-full gap-8">
                     ...
                     hover:bg-pink-600 w-1/2 py-2' onClick={retornar}>
                            Cancelar
                        </button>
                        <button
                            type='submit'
                            className='rounded text-white bg-cyan-500 
